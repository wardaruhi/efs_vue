                    ...
                    >
                      <v-card>
                        ...
                        <v-list v-show="isExpanded(item)" dense>
                          ...
                          <v-list-item>
                            <v-list-item-content>Share Details:</v-list-item-content>
                            <v-list-item-content class="align-end">{{ item.shares }} on {{ item.purchase_date }} for $ {{ item.purchase_price}}</v-list-item-content>
                          </v-list-item>
                        </v-list>
                      </v-card>
                    </v-col>
